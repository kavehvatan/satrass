      ...
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-16 grid md:grid-cols-2 items-center gap-10" dir="rtl">
        ...
        <div className="flex justify-center md:justify-start">
          ...
          >
            ...
            {/* لوگوی ساده S روی سینه (نقش‌ونگار برند) */}
            <path d="M150 210 h60 a8 8 0 0 1 0 16 h-44 a8 8 0 0 0 0 16 h48"
                  stroke="#f4c21f" strokeWidth="6" fill="none" strokeLinecap="round"/>
            <circle cx="156" cy="242" r="4" fill="#f4c21f"/>
            <circle cx="172" cy="242" r="4" fill="#f4c21f"/>
          </svg>
        </div>

        {/* مانیتور بزرگ با متن تماس داخلش */}
        <div className="flex justify-center md:justify-start">
